...
def detect_face_and_eyes(image_path, shape_predictor_path):
    """
    ...
    """
    shape_predictor = dlib.shape_predictor(shape_predictor_path)  # LOAD INSIDE FUNCTION using passed path
