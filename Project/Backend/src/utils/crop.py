from src.config.settings import CROP_PADDING_X, CROP_PADDING_Y
...
def crop_eye_with_eyebrows(image, eye_coords):
    ...
    """
    padding_x = CROP_PADDING_X  # Horizontal padding
    padding_y = CROP_PADDING_Y  # Vertical padding to include eyebrows
